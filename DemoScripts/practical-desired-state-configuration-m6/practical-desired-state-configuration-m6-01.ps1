...
Set-ADGroup -Add:@{'Member'="CN=COLLECTOR,CN=Computers,DC=GLOBOMANTICS,DC=COM"} -Identity:"CN=Event Log Readers,CN=Builtin,DC=WEF,DC=COM" -Server:"DC1.GLOBOMANTICS.COM" -Verbose

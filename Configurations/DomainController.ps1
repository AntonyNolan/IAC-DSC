...
Set-DscLocalConfigurationManager -Path .\DomainController -Verbose -Force
Start-DscConfiguration -ComputerName localhost -wait -force -Verbose -Path .\DomainController
